...
if __name__ == "__main__":
    indicies_of_interest = [100, 170, 350]
    for index_of_interest_in_clip in range(len(indicies_of_interest)):
        # First Clip Tim
        ...
        lines_to_plot = []
        index_of_interest = indicies_of_interest[index_of_interest_in_clip]#[160,310,350]
        for i in range(constants.K_STEPS):
            lines_to_plot.append([[],[],[]])
        with open('saved_data/paper_samples/frame_history_'+str(1)+'.pkl', 'rb') as f:
